 ...
 */
public class PingServiceOriginal {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new PingServiceOriginal(args);
    }

    public PingServiceOriginal(String[] args) throws Exception {
        ...
        String filePrefix = testNet ? "pingserviceOriginal-testnet" : "pingserviceOriginal-prodnet";
